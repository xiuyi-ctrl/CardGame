...
export const PASSIVES: Record<string, PassiveDef> = {
  ...
  hot_flame: { id: 'hot_flame', name: '烈焰', desc: '攻击命中附加灼烧 2（2 回合）', kind: 'scorch', value: 2 },
  venom_tail: { id: 'venom_tail', name: '毒尾', desc: '攻击命中附加中毒 2（2 回合）', kind: 'venom', value: 2 },
  hard_armor: { id: 'hard_armor', name: '硬甲', desc: '受到攻击时反伤 2 点', kind: 'thorns', value: 2 },

  // —— 第二阶进化 ——
  fury: { id: 'fury', name: '狂怒', desc: '生命低于 50% 时伤害 +2', kind: 'frenzy', value: 2 },
  deep_regen: { id: 'deep_regen', name: '深海再生', desc: '每回合开始恢复 3 点生命', kind: 'regen', value: 3 },
  ...
  lava_scorch: { id: 'lava_scorch', name: '熔火灼烧', desc: '攻击命中附加灼烧 3（2 回合）', kind: 'scorch', value: 3 },
  ...
  spore_venom: { id: 'spore_venom', name: '剧毒孢子', desc: '攻击命中附加中毒 3（2 回合）', kind: 'venom', value: 3 },
  ghost_step: { id: 'ghost_step', name: '幽灵疾步', desc: '战斗开始速度 +2', kind: 'spd', value: 2 },
