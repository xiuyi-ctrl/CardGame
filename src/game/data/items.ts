...
export const ITEMS: Record<string, ItemDef> = {
  ...
  atk_up: {
    ...
    desc: '战斗中使用：指定一只我方宠物，攻击 +30%（持续 3 回合）',
    kind: 'atk_up', price: 12,
    usableInBattle: true,
    battleDesc: '指定一只我方宠物，攻击 +30%（3 回合）',
    needsTarget: true,
  },
  spd_up: {
    id: 'spd_up', name: '速度药水', emoji: '💨',
    desc: '战斗中使用：指定一只我方宠物，速度 +30%（持续 3 回合）',
    kind: 'spd_up', price: 12,
    usableInBattle: true,
    battleDesc: '指定一只我方宠物，速度 +30%（3 回合）',
    needsTarget: true,
  },
  hp_up: {
  ...
  atk_down: {
    ...
    desc: '战斗中使用：指定一只敌方，攻击 -30%（持续 3 回合）',
    kind: 'atk_down', price: 15,
    usableInBattle: true,
    battleDesc: '指定一只敌方，攻击 -30%（3 回合）',
    needsTarget: true,
  },
  spd_down: {
    id: 'spd_down', name: '缓速药水', emoji: '🕸️',
    desc: '战斗中使用：指定一只敌方，速度 -30%（持续 3 回合）',
    kind: 'spd_down', price: 12,
    usableInBattle: true,
    battleDesc: '指定一只敌方，速度 -30%（3 回合）',
    needsTarget: true,
  },
  hp_down: {
