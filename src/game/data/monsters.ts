...
export const MONSTERS: Record<string, MonsterSpecies> = {
  ...
  momo_queen: {
    ...
    baseHp: 18, baseSpd: 4,
    skills: ['bite', 'leaf_needle', 'heal_light', 'shockwave'],
  ...
  fifi_king: {
    ...
    baseHp: 13, baseSpd: 6,
    skills: ['ember', 'double_hit', 'roar', 'shockwave'],
    desc: '菲菲的融合形态，高速度的爆发刺客，先手秒杀。',
    passive: 'hot_flame',
  ...
  gora: {
    ...
    baseHp: 19, baseSpd: 2,
    skills: ['steel_spike', 'roar', 'tail', 'shockwave'],
  ...
  mimi_king: {
    ...
    baseHp: 17, baseSpd: 4,
    skills: ['shadow_claw', 'poison_sting', 'double_hit'],
    desc: '咪咪的融合形态，毒杀刺客，多段攻击叠加中毒。',
    passive: 'venom_tail',
    evolutions: [{ to: 'mimi_god' }],
    tame: { difficulty: 0.4 }, rank: 2,
  },
  gora_god: {
    id: 'gora_god', name: '磐岩巨像', emoji: '🗿',
    baseHp: 32, baseSpd: 3,
    skills: ['steel_spike', 'tail', 'roar', 'shockwave', 'heal_light'],
    desc: '基基的最终形态，全游戏最高血量，减伤反伤自回复的不朽堡垒。',
    passive: 'rock_guard',
  ...
  lulu_god: {
    ...
    desc: '露露最终形态，全游戏血量最高的不朽坦克，配合再生几乎打不死。',
    passive: 'deep_regen',
    tame: { difficulty: 0.3 }, rank: 3,
  },
  fifi_god: {
    ...
    desc: '菲菲最终形态，全游戏速度最高的先手杀手，一击必杀的极致输出。',
